  ...
  return (
    <main className="min-h-screen bg-white overflow-hidden">
      ...
      <nav className="bg-white sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center h-[88px]">
          ...
          <div className="flex items-center h-full md:hidden">
            <button className="text-gray-700 p-2" aria-label="Abrir menú de navegación">
      ...
      {/* Formas decorativas estilo Accessin - Ocultas en móvil */}
      <div className="hidden md:block absolute top-0 right-0 w-64 h-64 bg-indigo-100 rounded-full opacity-20 -mr-32 -mt-32 z-0"></div>
      <div className="hidden md:block absolute bottom-48 left-0 w-96 h-96 bg-indigo-100 rounded-full opacity-20 -ml-48 z-0"></div>

      {/* Header / Hero */}
      <section className="relative py-16 md:py-20 px-4 overflow-hidden bg-white" itemScope itemType="https://schema.org/WebPageElement">
        <div className="container mx-auto max-w-4xl flex flex-col lg:flex-row items-center gap-8 md:gap-12 relative z-10 px-4 md:px-8 lg:px-16">
          <div className="flex-1 text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight" itemProp="headline">
              Tu celular es tu <span className="text-indigo-700">llave digital universal</span>
            </h1>
            <p className="text-lg sm:text-xl text-gray-500 mb-8 max-w-xl mx-auto lg:mx-0" itemProp="description">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link 
                href="#como-funciona" 
                className="border border-indigo-700 text-indigo-700 hover:bg-indigo-50 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-center transition-colors text-base sm:text-lg shadow-sm"
          ...
          <div className="flex-1 relative flex justify-center items-center">
            ...
            {/* Elementos decorativos alrededor de la imagen - Reducidos en móvil */}
            <div className="hidden sm:block absolute -bottom-4 -right-4 w-24 h-24 bg-indigo-200 rounded-lg z-0" aria-hidden="true"></div>
            <div className="hidden sm:block absolute -top-4 -left-4 w-16 h-16 bg-indigo-100 rounded-full z-0" aria-hidden="true"></div>
          </div>
        </div>
      </section>
      ...
      <section id="como-funciona" className="py-16 md:py-20 px-4 relative overflow-hidden">
        <div className="hidden lg:block absolute bottom-0 right-0 w-80 h-80 bg-indigo-50 rounded-full opacity-70 -mr-40 -mb-40"></div>
        <div className="hidden lg:block absolute top-20 left-0 w-64 h-64 bg-indigo-50 rounded-full opacity-70 -ml-32"></div>
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center mb-24">
            <div className="flex-1">
              <div className="relative w-full h-[400px] rounded-xl shadow-lg overflow-hidden bg-gray-50">
                <div className="w-full max-w-md mx-auto">
                  <Image
                    ...
                    width={400}
                    height={300}
                    className="rounded-xl object-cover w-full h-auto bg-gray-50"
                    priority
                  />
                </div>
              </div>
              ...
              <div className="relative w-full h-[400px] rounded-xl shadow-lg overflow-hidden bg-gray-50">
                <div className="w-full max-w-md mx-auto">
                  <Image
                    ...
                    width={400}
                    height={300}
                    className="rounded-xl object-contain p-2 w-full h-auto bg-gray-50"
                    priority
                  />
                </div>
              </div>
      ...
      <section className="py-16 md:py-20 px-4 bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-700 relative overflow-hidden">
        {/* Elementos decorativos de fondo */}
        <div className="absolute inset-0 bg-black bg-opacity-10"></div>
        <div className="hidden lg:block absolute top-0 left-0 w-96 h-96 bg-white bg-opacity-10 rounded-full -translate-x-48 -translate-y-48"></div>
        <div className="hidden lg:block absolute bottom-0 right-0 w-80 h-80 bg-white bg-opacity-10 rounded-full translate-x-40 translate-y-40"></div>
        
        <div className="container mx-auto max-w-4xl px-4 md:px-8 lg:px-16 relative z-10">
          <div className="text-center">
            <div className="inline-flex items-center px-4 py-2 bg-white bg-opacity-20 rounded-full text-indigo-700 text-sm font-semibold mb-6 md:mb-8 backdrop-blur-sm border border-white border-opacity-20">
            ...
            <p className="text-lg sm:text-xl md:text-2xl !text-white mb-8 md:mb-12 max-w-4xl mx-auto leading-relaxed font-light">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mt-8 md:mt-16">
               <div className="text-center">
                 <div className="w-14 h-14 md:w-16 md:h-16 bg-white bg-opacity-20 rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-4 backdrop-blur-sm border border-white border-opacity-20">
                   <svg className="w-6 h-6 md:w-8 md:h-8 text-indigo-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                   </svg>
                 </div>
                 <p className="!text-white text-xs md:text-sm font-semibold">Peajes automáticos</p>
               </div>
               ...
               <div className="text-center">
                 ...
                 <p className="!text-white text-xs md:text-sm font-semibold">Transporte público</p>
               </div>
               ...
               <div className="text-center">
                 ...
                 <p className="!text-white text-xs md:text-sm font-semibold">Servicios de salud</p>
               </div>
               ...
               <div className="text-center">
                 ...
                 <p className="!text-white text-xs md:text-sm font-semibold">Servicios municipales</p>
               </div>
             </div>
          </div>
        </div>
      ...
      <section className="py-12 md:py-16 flex justify-center bg-[#fafafa] px-4">
        <div className="w-full max-w-2xl bg-white rounded-3xl shadow-lg px-6 md:px-10 py-8 md:py-12 text-center border border-gray-200 font-sans">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 tracking-tight">
            Accedé gratis
          </h2>
          <p className="text-base md:text-lg text-gray-500 mb-8 md:mb-10 font-normal">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="!text-white font-medium">Vicente Zapata 203, Dorrego, Mendoza, Argentina</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li><span className="text-gray-400">Vicente Zapata 203, Dorrego, Mendoza, Argentina</span></li>
              </ul>
            </div>
          </div>
